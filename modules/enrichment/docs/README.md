---
description: enrichment 模块文档导航入口——注入契约、注册配方与 parse/tree 两个内嵌库契约文档的索引
---
...
- [cookbook](cookbook.md) —— 用法指南（cookbook）：注册配方（结构镜像 + 条件注入）、touch lane 三种消费角色、配对 provider 完整模式（稳态 resolve / 自编辑对账 / 镜像对齐）与语义速查
