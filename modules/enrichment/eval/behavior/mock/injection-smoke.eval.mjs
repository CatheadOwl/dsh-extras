 ...
 * mentions a Markdown path. The real `agent/pre-step` → enrichment →
...
export default {
  ...
  async inspect(_workspace, { trace }) {
    ...
    if (injections.length !== 1) {
      throw new Error(`expected exactly 1 enrichment relates injection, got ${injections.length}`)
    }
